...
<header id="header">
    ...
    <div class="header-nav">
        <section class="outer-wrapper">
            ...
            <div class="trust">
                <?php /*<a href="https://www.mcafeesecure.com/verify?host=www.keuze.nl" target="_blank"><img src="<?php echo keuze_theme_url( '/assets/images/logo-mcafeetest.png' );?>" alt="McAfee Test"></a>*/ ?>
                <?php /*
